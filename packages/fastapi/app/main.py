...
from app.routes import agents, chat, commands, credentials, harness_shares, harness_suggest, health, mcp_health, mcp_oauth, sandbox, terminal
...
app.include_router(harness_shares.router, prefix="/api/harness-shares", tags=["harness-shares"])
